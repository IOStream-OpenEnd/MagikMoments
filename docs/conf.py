...
htmlhelp_basename = 'MagikMomentsdoc'
...
latex_documents = [
    (master_doc, 'MagikMoments.tex', 'MagikMoments Documentation',
     'Supragya Raj', 'manual'),
]
...
man_pages = [
    (master_doc, 'magikmoments', 'MagikMoments Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MagikMoments', 'MagikMoments Documentation',
     author, 'MagikMoments', 'One line description of project.',
     'Miscellaneous'),
]
